...
function App() {
  ...
  const convert= ()=>{
    ...
    setConvertedAmount(isNaN(numericAmount) ? 0 : numericAmount * (currencyInfo[to] || 0))
  }
  ...
  return (
    ...
    style={{backgroundImage: `url('https://images.pexels.com/photos/3532540/pexels-photo-3532540.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')`}}>
      ...
      <div className="w-full">
        ...
        {/* e.preventDefault() stops the browser from trying to send form data to a server and page reload */}
        <form onSubmit={(e)=> {
          e.preventDefault();
          convert()
        }}>
          ...
          {/* Component InputBox reused here */}
